...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('rincian_belanja_umums', function (Blueprint $table) {
            $table->foreign(['bendahara_id'], 'rincian_belanja_umum_bendahara_id_foreign')->references(['id'])->on('bendaharas')->onUpdate('no action')->onDelete('cascade');
            $table->foreign(['kegiatan_id'], 'rincian_belanja_umum_kegiatan_id_foreign')->references(['id'])->on('kegiatans')->onUpdate('no action')->onDelete('cascade');
            $table->foreign(['kepala_dinas_id'], 'rincian_belanja_umum_kepala_dinas_id_foreign')->references(['id'])->on('kepala_dinas')->onUpdate('no action')->onDelete('cascade');
            $table->foreign(['kode_rekening_id'], 'rincian_belanja_umum_kode_rekening_id_foreign')->references(['id'])->on('kode_rekenings')->onUpdate('no action')->onDelete('cascade');
            $table->foreign(['penerima_id'], 'rincian_belanja_umum_penerima_id_foreign')->references(['id'])->on('pegawais')->onUpdate('no action')->onDelete('cascade');
            $table->foreign(['pptk_id'], 'rincian_belanja_umum_pptk_id_foreign')->references(['id'])->on('pptks')->onUpdate('no action')->onDelete('cascade');
            $table->foreign(['program_id'], 'rincian_belanja_umum_program_id_foreign')->references(['id'])->on('programs')->onUpdate('no action')->onDelete('cascade');
            $table->foreign(['sub_kegiatan_id'], 'rincian_belanja_umum_sub_kegiatan_id_foreign')->references(['id'])->on('sub_kegiatans')->onUpdate('no action')->onDelete('cascade');
