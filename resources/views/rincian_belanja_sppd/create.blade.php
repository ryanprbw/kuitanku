        ...
        <div class="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-md">
            ...
            <form action="{{ route('rincian_belanja_sppd.store') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="number" step="0.01" id="nomor_st" name="nomor_st" class="block w-full px-3 py-2 text-gray-700 border rounded-lg focus:ring focus:ring-blue-200" placeholder="Masukkan nilai PPH22">
                </div>
    
                {{-- PPH23 --}}
                <div>
                    <label for="tanggal_st" class="block mb-2 text-sm font-medium text-gray-700">tanggal_st</label>
                    <input type="date" step="0.01" id="tanggal_st" name="tanggal_st" class="block w-full px-3 py-2 text-gray-700 border rounded-lg focus:ring focus:ring-blue-200" placeholder="Masukkan nilai PPH23">
                </div>
                <div>
                    <label for="nomor_spd" class="block mb-2 text-sm font-medium text-gray-700">Nomor SPD</label>
                    <input type="number" step="0.01" id="nomor_spd" name="nomor_spd" class="block w-full px-3 py-2 text-gray-700 border rounded-lg focus:ring focus:ring-blue-200" placeholder="Masukkan nilai PPH22">
                </div>
    
                {{-- PPH23 --}}
                <div>
                    <label for="tanggal_spd" class="block mb-2 text-sm font-medium text-gray-700">tanggal_spd</label>
                    <input type="date" step="0.01" id="tanggal_spd" name="tanggal_spd" class="block w-full px-3 py-2 text-gray-700 border rounded-lg focus:ring focus:ring-blue-200" placeholder="Masukkan nilai PPH23">
                </div>
                ...
                <div class="flex justify-end space-x-4">
                    <a href="{{ route('rincian_belanja_sppd.index') }}" class="text-gray-700 hover:text-blue-600">Kembali</a>
